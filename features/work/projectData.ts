...
export const projects: Project[] = [
  {
    ...
    longDescription: "A comprehensive cloud-native Enterprise Resource Planning system designed specifically for high-volume automotive manufacturing.",
    ...
    challenges: "The client needed to synchronize real-time production data across 5 international plants with sub-second latency.",
    results: "Implemented a microservices architecture using Event Sourcing that reduced data synchronization delay by 95%.",
    screenshotUrls: [
  ...
  },
  {
    ...
    results: "Leveraged headless commerce architecture to deliver a 100/100 Lighthouse performance score.",
    screenshotUrls: [
        "https://images.unsplash.com/photo-1460925895917-afdab827c52f",
  ...
  // ... Keeping other projects but assuming they can have liveUrl too
  {
    ...
    results: "Deployed a multi-tenant SaaS architecture serving 50+ schools with zero data leakage incidents.",
    screenshotUrls: [
  ...
  },
  {
    ...
    longDescription: "An immersive real estate showcase platform allowing potential buyers to explore high-end properties in 3D.",
    colSpan: "md:col-span-2",
    rowSpan: "md:row-span-2",
    color: "#00f0ff",
    ...
    challenges: "High-end real estate clients needed a way to showcase unbuilt properties with hyper-realistic detail.",
    results: "Created an interactive 3D platform with high-fidelity shaders, leading to a 30% increase in pre-sales.",
    screenshotUrls: [
  ...
  },
  {
    ...
    results: "Engineered an optimized smart contract architecture handling 10,000+ concurrent users.",
    screenshotUrls: [
